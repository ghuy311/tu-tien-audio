        ...
        <div className="flex items-center justify-between gap-2 pt-1">
          ...
          <div className="flex items-center justify-center gap-2 flex-1 sm:flex-initial">
            <button
              onClick={onRewind15s}
              title="Lùi 15 giây"
              className="min-h-[44px] min-w-[44px] px-3 bg-neutral-800 hover:bg-neutral-700 text-neutral-200 rounded-lg text-xs font-bold transition active:scale-95 cursor-pointer border border-neutral-700 flex items-center justify-center gap-1"
            >
            ...
            <button
              ...
              title="Câu trước"
              className="min-h-[44px] min-w-[44px] px-3 bg-neutral-800 hover:bg-neutral-700 text-neutral-200 rounded-lg text-xs font-bold transition active:scale-95 cursor-pointer border border-neutral-700 flex items-center justify-center"
            >
            ...
            {isPlaying ? (
              <button
                onClick={onPause}
                className="min-h-[44px] px-6 bg-amber-600 hover:bg-amber-500 text-white rounded-lg text-sm font-bold transition active:scale-95 cursor-pointer shadow-md shadow-amber-950/40 flex items-center gap-2"
              >
              ...
              <button
                onClick={onPlay}
                className="min-h-[44px] px-6 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-sm font-bold transition active:scale-95 cursor-pointer shadow-md shadow-emerald-950/40 flex items-center gap-2"
              >
